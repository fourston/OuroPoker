...
export const SuccesСomplain: FC<IProps> = ({ open, onCancel, friend }) => {
        ...
        <View style={{ backgroundColor: 'rgba(13, 35, 69, 0.6)', flex: 1, display: 'flex' }}>
          ...
          >
            ...
            <View style={{ alignItems: 'center' }}>
              <Text style={styles.textSM}>Жалоба на пользователя</Text>
              ...
              <View style={{ backgroundColor: '#75A627', alignItems: 'center', width: '100%', paddingVertical: 9 }}>
                <Text style={styles.textSmall}>Ваша жалоба успешно отправлена !</Text>
              </View>
            </View>
          </View>
        </View>
