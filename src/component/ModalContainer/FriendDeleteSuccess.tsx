...
export const FriendDeleteSuccess: FC<IProps> = ({ open, onCancel, friend }) => {
        ...
        <View style={{ backgroundColor: 'rgba(13, 35, 69, 0.6)', flex: 1, display: 'flex' }}>
          ...
          >
            ...
            <View style={{ alignItems: 'center' }}>
              <Text style={styles.textSM}>Удаление из друзей</Text>
              <Image source={{ uri: uriImage }} style={{ width: 60, height: 60, marginTop: 20, marginBottom: 10 }} />
              ...
              <View style={{ backgroundColor: '#75A627', alignItems: 'center', width: '100%', paddingVertical: 9 }}>
                <Text style={styles.textSmall}>Пользователь успешно удален из друзей !</Text>
              </View>
            </View>
          </View>
        </View>
